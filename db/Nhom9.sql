...
INSERT INTO `admins` (`name`, `email`, `email_verified_at`, `password`, `remember_token`, `phone`, `address`, `status`, `type`, `created_at`, `updated_at`) VALUES
('Quan Ly', 'ql@gmail.com', NOW(), '123456', '123456123456123456123456', '123456789', 'Ha Noi', 'Active', 'Admin', NOW(), NOW()),
('Nhan Vien 1', 'nv1@gmail.com', NOW(), '123456', '123456123456123456123456', '123456789', 'Ha Noi', 'Active', 'Staff', NOW(), NOW());
...
('Organic Farm', 'organic-farm',  'Active', NOW(), NOW()),
('Green Valley', 'green-valley',  'Active', NOW(), NOW()),
('Pure Harvest', 'pure-harvest',  'Active', NOW(), NOW()),
('Eco Fresh', 'eco-fresh',  'Active', NOW(), NOW()),
('Natures Best', 'natures-best',  'Active', NOW(), NOW());
...
('Rau củ quả', 'rau-cu-qua', 'Active', NOW(), NOW()),
('Trái cây', 'trai-cay', 'Active', NOW(), NOW()),
('Ngũ cốc nguyên hạt', 'ngu-coc-nguyen-hat', 'Active', NOW(), NOW()),
('Sản phẩm từ sữa', 'san-pham-tu-sua', 'Active', NOW(), NOW()),
('Gia vị', 'gia-vi', 'Active', NOW(), NOW()),
('Thực phẩm chế biến sẵn', 'che-bien-san-huu-co', 'Active', NOW(), NOW());
-- --------------------------------------------------------
...
INSERT INTO `newscategories` (`name`, `slug`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Danh mục A', 'danh-m-c-a', 'Active', NULL, NULL),
('Tin tức sức khỏe', 'tin-tuc-suc-khoe', 'Active', NOW(), NOW()),
('Dinh dưỡng', 'dinh-duong', 'Active', NOW(), NOW()),
('Công thức nấu ăn', 'cong-thuc-nau-an', 'Active', NOW(), NOW()),
...
INSERT INTO `orders` (`user_id`, `firstname`, `lastname`, `address`, `phone`, `email`, `status`, `created_at`, `updated_at`) VALUES
(0, 'Nguyễn', 'Văn A', '123 Đường ABC, Hà Nội', '0901234567', 'vana@example.com', 'Cancelled', NOW(), NOW()),
(0, 'Trần', 'Thị B', '456 Đường XYZ, Hà Nội', '0912345678', 'thib@example.com', 'Processing', NOW(), NOW()),
(0, 'Lê', 'Văn C', '789 Đường DEF, Hà Nội', '0923456789', 'vanc@example.com', 'Delivered', NOW(), NOW());
